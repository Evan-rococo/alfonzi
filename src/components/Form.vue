...
<div>
	<form action="/action_page.php">
		...
		<div class="row2">
			<div class="col-26" style="text-align:center;">
				<input type="submit" style="background-color:green;border-radius: 25px; padding:.34em; padding-right:.8em; padding-left:.8em;" value="SUBMIT">
			</div>
		</div>
	</form>
</div>
